...
class Model(object):
    def __init__(self, config):
        ...
        init_checkpoint = os.path.join(file_path,"chinese_L-12_H-768_A-12/bert_model.ckpt")
        # 获取模型中所有的训练参数。
    ...
    def bert_embedding(self):
        ...
        bert_config = modeling.BertConfig.from_json_file(os.path.join(file_path,"chinese_L-12_H-768_A-12/bert_config.json"))  # 配置文件地址。
